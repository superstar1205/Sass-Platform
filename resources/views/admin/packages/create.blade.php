                    ...
                    <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                        <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                            <div
                                ...
                                <form class="space-y-8 divide-y divide-gray-200" id="createPackage"
                                    ...
                                    <div class="space-y-8 divide-y divide-gray-200 sm:space-y-5">
                                        ...
                                        <div class="pt-5">
                                            <div class="flex justify-end" x-data="{loading:false}">
                                                <button type="submit" @click="loading=true; document.getElementById('createPackage').submit();" x-bind:disabled="loading"
